...
public class SpitModel extends EntityModel<SpitEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData main = modelPartData.addChild("spit", ModelPartBuilder.create()
                        .uv(3, 3).cuboid(0.0F, 0.0F, -1.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                        .uv(3, 1).cuboid(-1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                        .uv(0, 2).cuboid(-1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                        .uv(0, 0).cuboid(0.0F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                , ModelTransform.NONE);
    ...
    public void render(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red, float green, float blue, float alpha) {
        spit.render(matrices, vertices, light, overlay, red, green, blue, alpha);
    }
}